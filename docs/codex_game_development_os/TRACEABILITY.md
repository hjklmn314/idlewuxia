...
|---|---|---|---|---|---|
| 首局流程 | `wuxiaFirstSessionFlow.js` | `wuxia_first_session_flow.json` | AssetRegistry | simulator + interactions | ARCH-001, T03-01 |
...
| 11 屏 UI | UI Flow Adapter 目标模块 | screen + UI experience registry | fonts/map/icons | 33 visual pairs | UI-ARCH-001, T05-01 |
