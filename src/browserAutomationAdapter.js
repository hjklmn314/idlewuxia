...
export function createBrowserAutomationAdapter({ uiFlowAdapter, render, persistence }) {
  ...
  return Object.freeze({
    ...
    pauseCombat: () => execute({ type: "pauseCombat" }),
    resumeCombat: () => execute({ type: "resumeCombat" }),
    replayCombat: () => execute({ type: "replayCombat" }),
    stopCombatReplay: () => execute({ type: "stopCombatReplay" }),
